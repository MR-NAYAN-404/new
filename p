...
try:
	...
	print('[\x1b[38;5;46mâ€¢\x1b[1;97m] [\x1b[\x1b[38;5;46mTEAM-NAYAN\x1b[1;97m]\x1b[1;91m')
...
\033[0;92mâ•‘âž£\033[0;94m TOOLS      :      \033[0;93m    Py3 MARSHAL        â•‘\033[0;92mâ•‘ ðŸ˜˜â•‘
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r[NAYAN][{P}{loop}{P}]+[{P}{len(id)}]{P} OK{P}={H}{ok}{P} {'{:.0%}'.format(loop/float(len(id)))}{P} "),
	sys.stdout.flush()
