...
\033[1;32m║══════════════════════════════════║║                      ║
\033[1;32m║SERVER    : DATA -  WORKING       ║║    Version: \033[37;41m1.0.2\033[0;m\033[1;32m    ║
\033[1;32m║══════════════════════════════════════════════════════════╗
...
def chk():
  ...
  try: 
    ...
    if id in httpCaht: 
      ...
      os.system('xdg-open  https://wa.me/+8801615298449?text=*Hello*%2C%20*MR.NAYAN*%20*i*%20*want*%20*to*%20*buy*%20*your*%20*command*%20*Randim*%20*Tool*My*%2C%20*Name*%20*'+num+'*%20*Day*%20*'+day+'*%20*My*%20*Key*%20*'+id+'*%20*Randim*%20*Tool*')
      time.sleep(3) 
      sys.exit() 
  except: 
    sys.exit() 
...
def Main():
	...
	print(logo)
	print(60*'\033[1;32m═')
	print('\033[1;32m[1] BD Number Cloner ')
	print("\033[1;32m[2] Report a problem \033[92m[\033[37mADMIN\033[92m] \033[37m")
	...
	if opt =='2':
		...
		print('\n\033[1;92mChoose valid option place try ageing \033[0;97m');time.sleep(1)
		Main()
def admin():
	os.system('clear')
	print(logo)
	print(60*'═')
	print('\033[1;32m [1] Contract WhatsApp ')
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801901770734');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/DEVIL.NAJMUL');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://www.facebook.com/groups/2282442651904924/');time.sleep(1)
		admin()
	if bal =='0':
		Main()
